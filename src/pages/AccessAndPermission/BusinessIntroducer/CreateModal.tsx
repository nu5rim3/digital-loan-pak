...
const CreateModal: React.FC<Props> = ({ visible, onClose, onCreate, editRecord }) => {
  ...
  return (
    <Modal
      ...
      onCancel={onClose}
      footer={null}
      title={editRecord ? 'Update Business Introducer' : 'Create Business Introducer'}
      width={800}
    >
      <Form form={form} layout="vertical" className="pt-4">
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item label="Contact No (03075105336)" name="empContactNo">
